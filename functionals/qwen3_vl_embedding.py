...
from transformers.models.qwen3_vl.modeling_qwen3_vl import Qwen3VLPreTrainedModel, Qwen3VLConfig, \
    Qwen3VLModel
...
class Qwen3VLEmbedder():
    def __init__(
        ...
        **kwargs
        ...
        multimodal_logger.info(f"The device for multimodal embedding is {device}")
        ...
        if video:
            ...
            if isinstance(video, list):
                ...
                if video.startswith(('http://', 'https://', 'file://')):
                    ...
                    video_content = str(video_path).replace('\\', '/')
